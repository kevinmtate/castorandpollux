			...
			{eventData.map((event: EventData, index: number) => (
				< article className="event" key={index} >
					<div className="event__top-container">
						...
						<a href="" className="event__top-container--venue">{`${event.artist} @ ${event.venue}`}</a>
					</div>
					<div className="event__center-container">
						<a href="" className="event__center-container--location-mobile">{event.location}</a>
						{/* <a href="" className="event__center-container--venue-mobile">{`${event.artist} @ ${event.venue}`}</a> */}
					</div>
